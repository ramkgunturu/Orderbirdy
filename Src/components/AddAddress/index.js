...
export default function AddAddress({ route }) {
  ...
  function onSubmit(values) {
    ...
    if (!selectedValue && selectCountry.value === "105") {
      ...
      // console.log(constants.API_BASE_URL + "add_address");
      Services(
        ...
        if (response.status === "Success") {
          if (route.params && route.params.onNavigationBack) {
  ...
  useEffect(() => {
    if (item) {
      // console.log(item);
      var getCountry = {
        label: item.country_info.title,
        value: item.country_info.id,
      };
      ...
      if (item && item.area) {
        var areaItem = {
          id: item.area,
          title: item.area_tit,
          title_ar: item.area_tit_ar,
        };
        setSelectedValue(areaItem);
      }
    }
  }, []);
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      >
        <Header
          screen={"AddAddress"}
          title={item ? "Edit Address" : language["Add Address"]}
          onAddAddress={() => {
      ...
      <Content>
        <Formik
          initialValues={{
            ...
            flat: item ? item.flat : "",
            avenue: item ? item.avenue : "",
            pincode: item ? item.pincode : "",
            state: item ? item.state : "",
            building: item ? item.building : "",
            city: item ? item.city : "",
            extradirections: item ? item.directions : "",
            houseno: item ? item.house : "",
            officeno: item ? item.building : "",
                          ...
                          >
                            ...
                            >
                              {errors.block && touched.block ? (
                                <Error
                                  display={errors.block && touched.block}
                                />
                              ) : null}
                            </TouchableOpacity>
                          </View>
                          ...
                          >
                            ...
                            >
                              {errors.state && touched.state ? (
                                <Error
                                  display={errors.state && touched.state}
                                />
                              ) : null}
                            </TouchableOpacity>
                          </View>
